...
#define RELEASE_START_POS		(485)								// リリース時タイトル選択位置スタート値
#define RELEASE_TUTORIAL_POS	(585)								// リリース時タイトル選択位置チュートリアル値
#define RELEASE_OPERATION_POS	(685)								// リリース時タイトル選択位置操作方法値
#define RELEASE_CREDIT_POS		(785)								// リリース時タイトル選択位置クレジット値
#define RELEASE_GAMEEND_POS		(885)								// リリース時タイトル選択位置終了値
//*****************************************************************************
// クラス定義
//*****************************************************************************
