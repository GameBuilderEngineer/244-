//=============================================================================
// タイトル遷移画像描画ヘッダー [TitleTransition.h]
// 制作者 飯塚春輝
//=============================================================================
#pragma once
#include "Sprite.h"
...
#define RELEASE_START_POS		(475)							// リリース時タイトル選択位置スタート値
#define RELEASE_TUTORIAL_POS	(575)							// リリース時タイトル選択位置チュートリアル値
#define RELEASE_OPERATION_POS	(675)							// リリース時タイトル選択位置操作方法値
#define RELEASE_CREDIT_POS		(775)							// リリース時タイトル選択位置クレジット値
#define RELEASE_GAMEEND_POS		(875)							// リリース時タイトル選択位置終了値
//*****************************************************************************
// クラス定義
//*****************************************************************************
...
private:
	...
	Sprite TitleGame;											// ゲーム
	Sprite TitleTutorial;										// チュートリアル
	Sprite TitleOperation;										// オペレーション
	Sprite TitleCredit;											// クレジット
	Sprite TitleGameend;										// ゲームエンド
	Sprite TitleGameB;											// ゲーム遷移時
	Sprite TitleTutorialB;										// チュートリアル遷移時
	Sprite TitleOperationB;										// オペレーション遷移時
	Sprite TitleCreditB;										// クレジット遷移時
	Sprite TitleGameendB;										// ゲームエンド遷移時
public:
