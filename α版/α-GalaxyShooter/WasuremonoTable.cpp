...
WasuremonoTable::WasuremonoTable(StaticMeshLoader* p): staticMeshLoader(p)
{
	...
	data[CHEWING_GUM].staticMesh = &(staticMeshLoader->staticMesh[staticMeshNS::WASUREMONO_HAT]);
	...
	data[ELECTRIC_FAN].staticMesh = &(staticMeshLoader->staticMesh[staticMeshNS::WASUREMONO_SCISSORS]);
	...
	data[JUMP_ROPE].staticMesh = &(staticMeshLoader->staticMesh[staticMeshNS::WASUREMONO_PAPER]);
	...
	data[TELEVISION].staticMesh = &(staticMeshLoader->staticMesh[staticMeshNS::WASUREMONO_SHOES]);
	...
	data[KENDAMA].staticMesh = &(staticMeshLoader->staticMesh[staticMeshNS::WASUREMONO_REDBULL]);
	...
	data[SOCCER_BALL].staticMesh = &(staticMeshLoader->staticMesh[staticMeshNS::WASUREMONO_BALL]);
	...
	data[CHRISTMAS_TREE].staticMesh = &(staticMeshLoader->staticMesh[staticMeshNS::WASUREMONO_TEAPOT]);
	...
	data[BICYCLE].staticMesh = &(staticMeshLoader->staticMesh[staticMeshNS::WASUREMONO_PLAYSTATION]);
	...
	data[DIAL_PHONE].staticMesh = &(staticMeshLoader->staticMesh[staticMeshNS::WASUREMONO_LIGHT]);
