...
WasuremonoTable::WasuremonoTable(StaticMeshLoader* p): staticMeshLoader(p)
{
	...
	data[ELECTRIC_FAN].staticMesh = &(staticMeshLoader->staticMesh[staticMeshNS::MEMORY_PILE]);
	...
	data[JUMP_ROPE].staticMesh = &(staticMeshLoader->staticMesh[staticMeshNS::MEMORY_PILE]);
	...
	data[TELEVISION].staticMesh = &(staticMeshLoader->staticMesh[staticMeshNS::MEMORY_PILE]);
	...
	data[KENDAMA].staticMesh = &(staticMeshLoader->staticMesh[staticMeshNS::MEMORY_PILE]);
	...
	data[DIAL_PHONE].staticMesh = &(staticMeshLoader->staticMesh[staticMeshNS::MEMORY_PILE]);
	...
	data[STUFFED_BUNNY].staticMesh = &(staticMeshLoader->staticMesh[staticMeshNS::STAR]);
