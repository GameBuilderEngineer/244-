...
//// スキンメッシュの作成
////============================================================================================================================================
//HRESULT AllocateHierarchy::createSkinMesh(LPDIRECT3DDEVICE9 _device, D3dxMeshContainerDerived *_meshContainer)
//{
//	D3DCAPS9 caps;	//	キャップ
//
...
//	D3dxFrameDerived *frame = NULL;	//	フレームポインタ
//	
//	*_newFrame = NULL;
//	frame = new D3dxFrameDerived;
//
//	if (frame == NULL)
//	{
//		// フレームポインタの解放
...
//	}
//
//	result = allocateName(_name, &frame->Name);
//
//	if (FAILED(result))
//	{
//		// フレームポインタの解放
...
//	UINT faceNumber = NULL;									//	フェイス数
//	UINT boneCount = NULL;									//	ボーンカウント
//	D3dxMeshContainerDerived *meshContainer = NULL;			//	メッシュコンテナポインタ
...
//	meshContainer->pAdjacency = new DWORD[faceNumber * 3];
...
//	}
//
//	memcpy(meshContainer->pAdjacency, _adjacency, sizeof(DWORD) * faceNumber * 3);
//	memset(meshContainer->texture, 0, sizeof(LPDIRECT3DTEXTURE9) * meshContainer->NumMaterials);
//
//	// 資料が提供されている場合は、それらをコピー
...
//		result = createSkinMesh(device, meshContainer);
//		if (FAILED(result))
//		{
//			// 割り当てられたメモリを適切にクリーンアップする
//			if (meshContainer != NULL)
