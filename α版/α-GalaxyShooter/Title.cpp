...
void Title::initialize(Direct3D9* _direct3D9, Input* _input, Sound* _sound, TextureLoader* _textureLoader, StaticMeshLoader* _staticMeshLoader, ShaderLoader* _shaderLoader, TextManager* _textManager)
{
	...
	//	camera[i].setRelative(D3DXQUATERNION(5.0f, -0.25f, -40.0f, 0.0f));
	...
	//	if (i == 0)
	//	{
	//		player[i]->initialize(playerNS::PLAYER_TYPE::TITLE_PLAYER, gameMasterNS::MODEL_TYPE::EVE, direct3D9->device, staticMeshLoader, textureLoader, shaderLoader);
	//	}
	//	else if (i == 1)
	//	{
	//		player[i]->initialize(playerNS::PLAYER_TYPE::TITLE_PLAYER, gameMasterNS::MODEL_TYPE::ADAM, direct3D9->device, staticMeshLoader, textureLoader, shaderLoader);
	//	}
