...
namespace uiTitleNS
{
	const int WIDTH_TITLE_LOGO = (1920 / 2);					//	幅
	const int HEIGHT_TITLE_LOGO = (250 / 2);					//	高さ
	const int WIDTH_TITLE_BAR = (1200 / 2);						//	幅
	const int HEIGHT_TITLE_BAR = (150 / 2);						//	高さ
	const int WIDTH_GAME_START = (1200 / 2);					//	幅
	const int HEIGHT_GAME_START = (150 / 2);					//	高さ
	const int WIDTH_TUTORIAL = (1200 / 2);						//	幅
	const int HEIGHT_TUTORIAL = (150 / 2);						//	高さ
	const int WIDTH_OPERATION = (1200 / 2);						//	幅
	const int HEIGHT_OPERATION = (150 / 2);						//	高さ
	const int WIDTH_CREDIT = (1200 / 2);						//	幅
	const int HEIGHT_CREDIT = (150 / 2);						//	高さ
	const int WIDTH_GAME_EXIT = (1200 / 2);						//	幅
	const int HEIGHT_GAME_EXIT = (150 / 2);						//	高さ
