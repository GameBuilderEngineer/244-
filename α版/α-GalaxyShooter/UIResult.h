...
namespace uiResultNS
{
	...
	const int RESULT_WINDOW_WIDTH = (3840 / 2);																		//	幅
	const int RESULT_WINDOW_HEIGHT = (1340 / 2);																	//	高さ
	const int PLAYER_NUMBER_WIDTH = (936 / 2);																		//	幅
	const int PLAYER_NUMBER_HEIGHT = (254 / 2);																		//	高さ
	const int RESULT_WIDTH = (630 / 2);																				//	幅
	const int RESULT_HEIGHT = (240 / 2);																			//	高さ
